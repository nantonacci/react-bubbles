...
Use authentication to protect access to certain data. Use protected routes to prevent a user accessing certain pages without logging in.

- [ ] Describe how web servers work.

A web server hosts code for different websites, is connected to the internet, and serves websites on demand.
